            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">🤖 AI-Powered Matching</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Get personalized internship recommendations based on your skills, interests, and career goals.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Data Science", "Web Dev", "Marketing"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                              className="bg-[#e78a53] rounded px-3 py-2 flex items-center gap-2 text-white text-sm font-medium shadow-sm"
                            ...
                            >
                              <div className="w-4 h-4 flex items-center justify-center">
                                {index === 0 && <span className="text-xs text-white">📊</span>}
                                {index === 1 && <span className="text-xs text-white">💻</span>}
                                {index === 2 && <span className="text-xs text-white">📈</span>}
                              </div>
                        ...
                        {/* Right Column */}
                        <div className="flex flex-col gap-3">
                          {["Startups", "Corporates", "Government"].map((item, index) => (
                            <motion.div
                              key={`right-${index}`}
                              className="bg-[#e78a53] rounded px-3 py-2 flex items-center gap-2 text-white text-sm font-medium shadow-sm"
                              initial={{ opacity: 1, x: 0 }}
                            ...
                            >
                              <div className="w-4 h-4 flex items-center justify-center">
                                {index === 0 && <span className="text-xs text-white">🚀</span>}
                                {index === 1 && <span className="text-xs text-white">🏢</span>}
                                {index === 2 && <span className="text-xs text-white">🏛️</span>}
                              </div>
                              <span className="text-white">{item}</span>
                            </motion.div>
                          ))}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">✅ Government Verified</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Safe & authentic opportunities under the PM Internship Scheme with verified companies across
                      India.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">📊 Real-Time Dashboard</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Track your applications & progress with smart notifications and never miss a deadline.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">🌐 Pan-India Opportunities</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      From startups to corporates across domains - find internships that fit your strengths nationwide.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">

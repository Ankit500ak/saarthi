...
const pricingPlans = [
  {
    name: "Student",
    price: "Free",
    description: "Perfect for students getting started with internships",
    features: ["AI-powered matching", "Basic profile creation", "Apply to 5 internships/month", "Community support"],
    popular: false,
  ...
  },
  {
    ...
    monthlyPrice: 99,
    annualPrice: 79,
    description: "For serious students seeking the best opportunities",
    features: [
  ...
  },
  {
    ...
    monthlyPrice: 999,
    annualPrice: 799,
    description: "For colleges and universities managing student placements",
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-white">Your Internship in 4 Easy Steps</span>
          </motion.div>
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
            From profile creation to landing your dream internship - Sarthi guides you every step of the way.
          </p>
          ...
          >
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                !isAnnual ? "bg-primary text-white shadow-lg" : "text-foreground hover:text-primary"
              }`}
            >
              Monthly
            </button>
                ...
                <div className="flex items-baseline justify-center gap-1 mb-2">
                  {plan.price ? (
                    ...
                    <>
                      ...
                      <span className="text-white/80 text-lg">{isAnnual ? "/year" : "/month"}</span>
                    </>
                  )}
                </div>
        ...
        >
          <p className="text-white/80 mb-4">Need a custom solution for your institution? We're here to help.</p>
          <motion.button
